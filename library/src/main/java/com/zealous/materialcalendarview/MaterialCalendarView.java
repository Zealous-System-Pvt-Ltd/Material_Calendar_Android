...
import com.zealous.materialcalendarview.format.ArrayWeekDayFormatter;
import com.zealous.materialcalendarview.format.DateFormatTitleFormatter;
import com.zealous.materialcalendarview.format.DayFormatter;
import com.zealous.materialcalendarview.format.MonthArrayTitleFormatter;
import com.zealous.materialcalendarview.format.TitleFormatter;
import com.zealous.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.zealous.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.zealous.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.zealous.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.zealous.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.zealous.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.zealous.materialcalendarview.format.TitleFormatter)
     */
